...
app.use(cors({ credentials: true, origin: 'https://camilovega.site',methods: 'GET,HEAD,PUT,PATCH,POST,DELETE'}))

app.options('*', (req, res) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://camilovega.site');
